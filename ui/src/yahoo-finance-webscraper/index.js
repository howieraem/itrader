...
const BASE_URL = 'https://query1.finance.yahoo.com/v7/finance/quote';

const getSingleStockInfo = (symbol, proxyUrl='') => new Promise((resolve, reject) => {
  ...
  let url = `${proxyUrl}${proxyUrl ? '/' : ''}${BASE_URL}?symbols=${symbol}`;
